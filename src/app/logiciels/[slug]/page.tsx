...
export default async function ProductPage({ params }: PageProps) {
  ...
  const breadcrumb = generateBreadcrumbSchema([
    { name: 'Accueil', url: '/' },
    { name: 'Logiciels ATS', url: '/logiciels' },
      ...
      <article className="py-12">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            ...
            <div>
              ...
              <p className="font-medium">
                {product.pricing.freeTrial
                  ? `Oui (${product.pricing.freeTrialDays ?? '?'} jours)`
                  : 'Non'}
              </p>
            </div>
          </div>
          ...
          <section className="mt-10">
            <h2 className="text-2xl font-bold text-gray-900">Tarifs et engagements</h2>
          ...
          <section className="mt-10 grid gap-6 sm:grid-cols-2">
            <div className="rounded-xl border border-green-200 bg-green-50 p-6">
              <h3 className="font-semibold text-green-800">Points forts</h3>
            ...
            <div className="rounded-xl border border-red-200 bg-red-50 p-6">
              <h3 className="font-semibold text-red-800">Points faibles</h3>
              <ul className="mt-3 space-y-2">
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      >
                        {ext.available ? 'Disponible' : 'Non disponible'}
                      </span>
                    </div>
                    {ext.available && (
